...
public class CerealBlockBlock extends ChrisomodeElements.ModElement {
	@ObjectHolder("chrisomode:cerealblock")
	public static final Block block = null;
	public CerealBlockBlock(ChrisomodeElements instance) {
		super(instance, 19);
	}
